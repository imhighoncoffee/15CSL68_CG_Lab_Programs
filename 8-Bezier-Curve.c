...
GLfloat ctrlPts1[4][4][3] =
	{
		{{-300, 20, 0.0}, {-100, 20, 150.0}, {100, 20, 0}, {250, 20, 150.0}},
		{{-300, 45, 0.0}, {-100, 45, 150.0}, {100, 45, 0}, {250, 45, 150.0}},
		{{-300, 70, 0.0}, {-100, 70, 150.0}, {100, 70, 0}, {250, 70, 150.0}},
		{{-300, 95, 0.0}, {-100, 95, 150.0}, {100, 95, 0}, {250, 95, 150.0}}};
GLfloat ctrlPts2[4][4][3] =
	{
		{{-300, 95, 0.0}, {-100, 95, 150.0}, {100, 95,0}, {250, 95, 150.0}},
		{{-300, 120, 0.0}, {-100, 120, 150.0}, {100, 120, 0}, {250, 120, 150.0}},
		{{-300, 145, 0.0}, {-100, 145, 150.0}, {100, 145, 0}, {250, 145, 150.0}},
		{{-300, 170, 0.0}, {-100, 170, 150.0}, {100, 170, 0}, {250, 170, 150.0}}};
GLfloat ctrlPts3[4][4][3] =
	{
		{{-300, 170, 0.0}, {-100, 170, 150.0}, {100, 170, 0}, {250, 170, 150.0}},
		{{-300, 195, 0.0}, {-100, 195, 150.0}, {100, 195, 0}, {250, 195, 150.0}},
		{{-300, 220, 0.0}, {-100, 220, 150.0}, {100, 220, 0}, {250, 220, 150.0}},
		{{-300, 245, 0.0}, {-100, 245, 150.0}, {100, 245, 0}, {250, 245, 150.0}}};
